...
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_dEmP7I84CnYmwNRNLF2SHJasEBveGICIeASdUXkfIs", PUBLIC: process.env.PUBLIC, _: process.env._ })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"2.16.10"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "2.16.10",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_dEmP7I84CnYmwNRNLF2SHJasEBveGICIeASdUXkfIs", PUBLIC: process.env.PUBLIC, _: process.env._ }).MODE
  },
  telemetry: {
...
export {
  clerkMiddleware as a,
  clerkClient as b,
  createRouteMatcher as c
};
